...
# Script to create the complete FileOrganizerApp project structure
# Run this script to generate all necessary files

echo "🏗️  Creating FileOrganizerApp project structure..."

# Create the main project directory
mkdir -p FileOrganizerApp
cd FileOrganizerApp
...
cat > Sources/FileOrganizerApp.swift << 'EOF'
import Cocoa
import Foundation
...
<dict>
    ...
    <string>FileOrganizerApp</string>
    <key>CFBundleIdentifier</key>
    <string>com.imagereviewer.fileorganizer</string>
    ...
    <string>This app needs access to your documents folder to organize image files based on review feedback.</string>
    <key>NSDesktopFolderUsageDescription</key>
    <string>This app may need access to your desktop folder to organize image files.</string>
    <key>NSDownloadsFolderUsageDescription</key>
    <string>This app may need access to your downloads folder to organize image files.</string>
...
[
  ...
  {
    "timestamp": "2025-07-22T05:03:18.464+00:00",
    "reviewer": "Mimi",
    "folderName": "HOME",
    "imageName": "G0001531_01-V02.jpg",
    "productCode": "G0001531",
    "comments": "Approved on 03:03 PM - JUL 22",
    "status": "Approved",
    "approved": "Yes",
  ...
  {
    "timestamp": "2025-07-22T05:02:45.123+00:00",
    "reviewer": "John",
    "folderName": "HOME",
    "imageName": "G0001532_CU01-V01.jpg",
    "productCode": "G0001532",
    "comments": "Image quality too low, needs retake",
    "status": "Rejected",
    "approved": "No",
    "attachments": "",
  ...
  {
    "timestamp": "2025-07-22T05:01:30.456+00:00",
    "reviewer": "Sarah",
    "folderName": "HOME",
    "imageName": "G0001533-V03.heic",
    "productCode": "G0001533",
    "comments": "Perfect composition and lighting",
    "status": "Approved",
    "approved": "Yes",
    "attachments": "",
    "productName": "Glass Decorative Plate",
    "imageVersion": 3
  },
  {
    "timestamp": "2025-07-22T05:00:15.789+00:00",
    "reviewer": "Mike",
    "folderName": "HOME",
    "imageName": "G0001534_01-V01.png",
    "productCode": "G0001534",
    "comments": "Subject is blurry, please reshoot",
    "status": "Rejected",
    "approved": "No",
    "attachments": "",
...
1. Export JSON data from your image review web app
2. Open this app and select the JSON file
3. Choose the folder containing your images
4. Click "Organize Files"

The app will create "Approved" and "Not Approved" folders and sort your images automatically.
...
- If the app won't open: Right-click → Open → Open (to bypass security)
- If build fails: Make sure Xcode Command Line Tools are installed
- If files aren't found: Check that filenames in JSON match actual files

For more help, see the full README or documentation.
EOF

echo "✅ FileOrganizerApp project created successfully!"
echo ""
echo "📁 Created in: $(pwd)"
echo ""
echo "Next steps:"
echo "1. cd FileOrganizerApp"
echo "2. ./build.sh"
echo "3. open FileOrganizerApp.app"
EOF
