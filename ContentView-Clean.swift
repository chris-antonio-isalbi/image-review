...
struct ContentView: View {
                    ...
                    HStack {
                        VStack(alignment: .leading, spacing: 4) {
                            Text("HTTP Server Status:")
                                .font(.headline)
                            Text("Web integration available - see WEB-APP-INTEGRATION.md")
                                .font(.caption)
    ...
    private func showWebInstructions() {
        let alert = NSAlert()
        alert.messageText = "Web App Integration Available"
        alert.informativeText = """
        Full web app integration is available with HTTP server functionality.
        
        Check the WEB-APP-INTEGRATION.md file in your project for:
        • Step-by-step setup instructions
        • JavaScript code for your web app
        • Complete API documentation
        
        The watch folder and manual processing work perfectly without web integration!
        """
